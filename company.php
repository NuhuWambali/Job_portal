...
<head>
	...
	<title>FastJobs  - <?php echo "$compname"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="employers.php" class="home">Employers</a></li>
						<li><span style="color:#0cb189"><?php echo "$compname"; ?></span></li>
					</ol>
					...
					<div class="row">
							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-header text-center">
										...
										<ul class="meta-list clearfix">
											<li>
												...
												<span style="color:#0cb189; text-align:center; font-size:16px"><?php echo "$compesta"?></span>
											</li>
											<li>
												<h4 class="heading">Type:</h4>
												<span style="color:#0cb189; text-align:center; font-size:16px"><?php echo "$comptype"; ?></span>
											</li>
											<li>
												<h4 class="heading">People:</h4>
												<span style="color:#0cb189; text-align:center; font-size:16px"><?php echo "$comppeopl"; ?>	</span>
											</li>
											<li>
												<h4 class="heading">Website: </h4>
												<a style="color:#0cb189"  href="https://<?php echo "$compweb"; ?>"><?php echo "$compweb"; ?></a>
											</li>
										</ul>
									...
									$type = $row['type'];
									if ($type == "Freelance") {
									$sta = '<span class="job-label label " style="color:#fff; background-color:#000>Freelance</span>';
											  
									}
									if ($type == "Part-time") {
									$sta = '<span class="job-label label "  style="color:#fff; background-color:#1134d1">Part-time</span>'; 
											  
									}
									if ($type == "Full-time") {
									$sta = '<span class="job-label label "  style="color:#fff; background-color:green">Full-time</span>';
										 ...
										 ?>
											...
											<div class="content">
												<div class="job-item-list-info">
													...
													<div class="row">
														...
														<div class="col-sm-7 col-md-8">
															...
															<span>at <a style="color:#0cb189" href="company.php?ref=<?php echo "$company_id"; ?>"><?php echo "$compname"; ?></a></span>
															<?php echo "$sta"; ?>
															</div>
												...
												<div class="job-item-list-bottom">
													...
													<div class="col-sm-5 col-md-4">
														<a href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn ">View This Job</a>
													</div>
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#0cb189; color:white" '; } ?>  href="company.php?ref=<?php echo "$company_id"; ?>&page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
