...
<head>
	...
	<title>FastJobs - Applicants for the job <?php echo "$job_title"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span class="home">Applicants for the job <?php echo "$job_title"; ?></</span></li>
					</ol>
					...
					<div class="employee-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
									...
									<div class="employee-grid-item">
										...
										<a  href="../employee-detail.php?empid=<?php echo $rowb['member_no']; ?>" class="clearfix">
											...
											<div class="content">
												...
												<h4 class="home"><?php echo $rowb['first_name'] ?> <?php echo $rowb['last_name'] ?></h4>
                                                ...
                                                <h6 class="text-primary"><?php echo $rowb['title'] ?></h6>
											     <span class="home"><?php echo "$post_month"; ?> <?php echo "$post_date"; ?>, <?php echo "$post_year"; ?></span>	
							...
							?>
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#0cb189; color:white" '; } ?>  href="view-applicants.php?jobid=<?php echo "$job_id"; ?>&page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
