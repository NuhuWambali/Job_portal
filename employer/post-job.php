			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step ">
						...
						<li><a class="home"><?php echo "$compname"; ?></a></li>
						<li><span class="home">Post a Job</span></li>
					</ol>
					...
					<div class="row">
							...
							<div class="col-sm-5 col-md-4">
								...
								<div class="company-detail-sidebar">
									...
									<h2 class="heading mb-15"><h4 class="home"><?php echo "$compname"; ?></h4>
									...
									<ul class="meta-list clearfix">
										...
										<span class="home">	<?php echo "$esta"; ?> </span>
										</li>
										<li>
											<h4 class="heading">Type:</h4>
											<span class="home"><?php echo "$mytitle"; ?> </span>
										</li>
										<li>
											<h4 class="heading">People:</h4>
											<span class="home"><?php echo "$mypeople"; ?> </span>
										</li>
										<li>
											<h4 class="heading">Website: </h4>
											<a class="home" href="https://<?php echo "$myweb"; ?>"><?php echo "$myweb"; ?></a>
										</li>
										<li>
									...
									<a href="./" class="btn  mt-5"><i class="fa fa-pencil-square-o mr-5"></i>Edit</a>
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-8 col-md-8">
													...
													<div class="form-group">
														<label class="home">Job Title</label>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label class="home">Country</label>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label class="home">Job Category</label>
											    ...
											    <div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label class="home">Closing Date</label>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														<label class="home">Job Type:</label>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														<label class="home">Experience:</label>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label class="home">Job Description</label>
														<textarea class="form-control bootstrap3-wysihtml5" name="description" required  style="height: 200px;"></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label class="home">Job Responsibilies</label>
														<textarea name="responsiblities" required class="form-control bootstrap3-wysihtml5"  style="height: 200px;"></textarea>
													</div>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label clas="home">Requirements</label>
														<textarea name="requirements" required class="form-control bootstrap3-wysihtml5 "  style="height: 200px;"></textarea>
													</div>
												...
												<div class="col-sm-6 mt-30">
													<button type="submit"  onclick = "validate(this)" class="btn  btn-lg">Post Your Job</button>
												</div>
