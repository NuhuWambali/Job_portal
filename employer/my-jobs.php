			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span class="home">My Jobs</span></li>
					</ol>
									...
									<?php require 'constants/check_reply.php'; ?>
									  ...
									  <?php
                                        ...
                                        foreach($result as $row)
                                        {
										   ...
										   if ($type == "Freelance") {
											 $sta = '<span class="label " style="color:#fff; background-color:#000">Freelance</span>';
											  
										   }
										   if ($type == "Part-time") {
											 $sta = '<span class="label " style="color:#fff; background-color:#1134d1">Part-time</span>';
											  
										   }
										   if ($type == "Full-time") {
											 $sta = '<span class="label " style="color:#fff; background-color:green">Full-time</span>';
										   ...
										   ?>
											...
											<p class="date text-muted font12 font-italic home">Deadline - <?php echo "$deadline"; ?></p>
											</div>
