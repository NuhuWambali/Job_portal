			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span class="home"><?php echo "$jobtitle"; ?></span></li>
					</ol>
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-company-overview  mt-0 clearfix">
										...
										<div class="section-title-02">
											<h3 class="text-left home"><?php echo "$jobtitle"; ?></h3>
										</div>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														...
														<select name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															...
															<option <?php if ($jobtype == "Full-time") { print ' selected '; } ?> value="Full-time" data-content="<span class='label ' style='color:#fff;background-color:green'>Full-time</span>">Full-time</option>
															<option <?php if ($jobtype == "Part-time") { print ' selected '; } ?> value="Part-time" data-content="<span class='label ' style='color:#fff; background-color:#1134d1'>Part-time</span>">Part-time</option>
															<option <?php if ($jobtype == "Freelance") { print ' selected '; } ?> value="Freelance" data-content="<span class='label ' style='color:#fff; background-color::#000'>Freelance</span>">Freelance</option>
														</select>
													</div>
