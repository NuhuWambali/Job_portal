...
<head>
	...
	<title>FastJobs  - Company Profile</title>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-action text-center">
										...
										<a href="post-job.php" class="btn  btn-sm btn-inverse">Post a Job</a>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
										...
										<div class="form-group bootstrap3-wysihtml5-wrapper">
										<label class="home" >Company Logo</label>
										<input class="home" accept="image/*" type="file" name="image"  required >
										</div>
										...
										?><a onclick = "return confirm('Are you sure you want to delete your logo ?')" class="btn  btn-inverse" href="app/drop-dp.php">Delete</a> <?php
										}
										?>
										</div>
										</div>
