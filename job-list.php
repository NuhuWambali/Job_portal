...
<head>
	...
	<title>FastJobs - <?php echo "$title"; ?></title>
						...
						<div class="second-search-result-inner">
							...
							<div class="row">
								...
								<div class="col-xss-12 col-xs-6 col-sm-4 col-md-2">
									<button name="search" value="✓" type="submit" class="btn btn-block" style="color:#fff; background-color:#0cb189;">Search</button>
								</div>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span style="color:#0cb189"><?php echo "$title"; ?></span></li>
					</ol>
					...
					<div class="result-wrapper">
						<div class="row">		
							<div class="col-sm-12 col-md-12 mt-25">
								...
								if ($type == "Freelance") {
								$sta = '<span class="job-label label label-success" style="color:#fff; background-color:#000">Freelance</span>';
											  
								}
								if ($type == "Part-time") {
								$sta = '<span class="job-label label label-danger" style="color:#fff; background-color:#1134d1">Part-time</span>';
											  
								}
								if ($type == "Full-time") {
								$sta = '<span class="job-label label label-warning" style="color:#fff; background-color:green">Full-time</span>';
												...
												<div class="row">
													...
													<div class="col-sm-7 col-md-8">
														...
														<div class="meta-div clearfix mb-25">
															<span style="color:#000">at <a href="company.php?ref=<?php echo "$compid"; ?>" style="color:#0cb189"><?php echo "$thecompname"; ?></a></span>
															<?php echo "$sta"; ?>
														</div>
														
														<p class="texing character_limit" style="color:#0cb189"><?php echo $row['description']; ?></p>
													</div>
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#0cb189; color:white" '; } ?>  href="job-list.php?page=<?php echo "$b"; ?><?php if ($fromsearch == true) { print '&category='.$cate.'&country='.$country.'&search=✓'; }?>"><?php echo $b." "; ?></a></li><?php
                                 }	
