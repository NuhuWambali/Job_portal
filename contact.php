...
<head>
	...
	<title>FastJobs - Contact Us</title>
...
<body class="not-transparent-header">
	...
	<div class="container-wrapper">
		...
		<header id="header">
			...
			<div id="registerModal" style="background-color:#0cb189;" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list">
						<li><a href="./" style="color:#0cb189">Home</a></li>
						<li><span  style="color:#0cb189">Contact Us</span></li>
					</ol>
					...
					<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label for="inputName" style="color:#0cb189">Your Name <span class="font10 ">(required)</span></label>
											<input id="inputName" name="fullname" type="text" class="form-control" data-error="Your name is required" style="color:#0cb189;border:1px solid #0cb189" required>
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label for="inputEmail" style="color:#0cb189">Your Email <span class="font10 " >(required)</span></label>
											<input id="inputEmail"  name="email" type="email" class="form-control" data-error="Your email is required and must be a valid email address" style="color:#0cb189;border:1px solid #0cb189" required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-sm-12">
										...
										<div class="form-group">
											<label for="inputMessage" style="color:#0cb189">Message <span class="font10 ">(required)</span></label>
											<textarea id="inputMessage" name="message" class="form-control" rows="8" data-minlength="50" data-error="Your message is required and must not less than 50 characters" style="color:#0cb189;border:1px solid #0cb189" required></textarea>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-sm-12 text-right">
										<button type="submit" class="btn  mt-5" style="color:#fff;background-color:#0cb189;border:1px solid #0cb189">Send Message</button>
									</div>
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
										<h5 style="color:#0cb189">Address</h5>
										<address style="color:#0cb189"> Kampala International University <br/> Dar es salaam <br/>Tanzania</address>
								</li>
								<li>
										<h5 style="color:#0cb189">Email</h5><a href="mailto:fastjobs.nuhu@gmail.com">fastjobs.nuhu@gmail.com</a>
								</li>
								<li>
										<h5 style="color:#0cb189">Phone Number</h5><a href="tel:+255 613 172 799">+255 613 172 799</a>
								</li>

								<li>
										<h5 style="color:#0cb189">Social Networks</h5>
