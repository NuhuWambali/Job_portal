			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list">
						...
						<li><span  style="color:#0cb189">Access your account</span></li>
					</ol>
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
								...
								<a data-toggle="modal" onclick = "reset_text()" href="#forgotPasswordModal" style="color:#fff">Forgot password?</a> 
							    </div>
						      </div>	
...
<button type="submit" class="btn " >Login</button>
				...
				<div class="modal-body">
					<div class="row gap-20">
						...
						<div class="col-sm-12 col-md-12">
							<p class="mb-20" style="color:#fff;">Enter the email address associated to your account, we will send you the link to reset your password</p>
						</div>
						...
						<div class="col-sm-12 col-md-12">
							<div class="login-box-box-action">
								<span style="color:#fff;"> Return to <a data-dismiss="modal" style="color:#000">Log-in</a>
								<p id="data"></p>
							</div>
				...
				<div class="modal-footer text-center">
					<button  onclick="update(mymail.value)" type="submit" class="btn ">Restore</button>
					<button type="button" data-dismiss="modal" class="btn  btn-inverse">Close</button>
				</div>
