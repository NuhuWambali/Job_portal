			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span style="color:#0cb189">Employees</span></li>
					</ol>
						...
						<div class="GridLex-gap-15-wrappper">
									...
									<div class="employee-grid-item">
										...
										<a href="employee-detail.php?empid=<?php echo $row['member_no']; ?>" class="clearfix">
											...
											<div class="content">
												...
												<h4 style="color:#0cb189;"><?php echo $row['first_name'] ?> <?php echo $row['last_name'] ?></h4>
                            ...
                            $total_records++;
	                        ...
	                        }catch(PDOException $e)
                             {
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#0cb189; color:white" '; } ?>  href="employees.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
