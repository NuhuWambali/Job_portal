...
<head>
	...
	<title>FastJobs - Reset Password</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list">
						...
						<li><span class="home">Reset Password</span></li>
					</ol>
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
                                ...
                                <div class="modal-header">
                                <h4 class="modal-title text-center home">Reset your password</h4>
                                </div>
                                ...
                                <label class="home">New password</label>
                                <input class="form-control home" placeholder="Min 8 and Max 20 characters" name="password" required type="password"> 
                                </div>
                                ...
                                <div class="form-group"> 
                                <label clas="home">Confirm New Password</label>
                                <input class="form-control home" placeholder="Min 8 and Max 20 characters" name="confirmpassword" required type="password"> 
                                </div>
...
print '
<div class="modal-footer text-center">
<button type="submit" onclick="return val();"  class="btn ">Reset my password</button>
</div>';	
}
