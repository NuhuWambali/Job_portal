...
<head>
	...
	<title>FastJobs - Employers</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span style="color:#0cb189">Employers</span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="company-grid-wrapper top-company-2-wrapper">
						...
						<div class="GridLex-gap-30">
							...
							<p class="texting font600 home"><?php echo $row['title'];?><p>
							<p class="mata-p clearfix"><span class="text-primary font700">Read More</span> <span class="pull-right icon"><i class="fa fa-long-arrow-right" style="color:#0cb189"></i></span></p>
							</div>
