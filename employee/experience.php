...
<head>
	...
	<title>FastJobs - Experience</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span class="home">Experience</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a>
															...
															<h4 class="home"><?php echo "$title"; ?></h4>
															
															<div class="row">
																<div class="col-sm-12 col-md-7">
																	<i class="fa fa-building text-primary mr-5 home"></i><strong class="mr-10 home"><?php echo $row['institution']; ?></strong>
																</div>
																<div class="col-sm-12 col-md-5 mt-10-sm">
																	<i class="fa fa-calendar  text-primary mr-5 home"></i><span class="home"> <?php echo "$start_date"; ?> <b>to</b> <?php echo "$end_date"; ?></span>
																</div>
															</div>
									...
									<a href="app/drop-experience.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this experience ?')" class="btn btn-sm btn-inverse">Delete</a>
