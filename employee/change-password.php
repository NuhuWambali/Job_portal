...
<head>
	...
	<title>FastJobs - Change Password</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span class="home">Change Password</span></li>
					</ol>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li class="active" >
										<a href="change-password.php" style="color:#0cb189"><i class="fa fa-key "></i> Change Password</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2 style="color:#0cb189">Change Password</h2>
											...
											<div class="row gap-20">
                                             <?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-12 mt-10">
													<button type="submit" onclick="return check_passwords();" class="btn  ">Update</button>
													<button type="reset" class="btn btn-inverse">Cancel</a>
												</div>
