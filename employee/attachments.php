...
<head>
	...
	<title>FastJobs - Other Attachments</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span class="home">Other Attachments</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a   href="view-attachment.php?id=<?php echo $row['id']; ?>" >
															...
															<h4 class="home"><?php echo $row['title']; ?></h4>
															
															<div class="row">
																<div class="col-sm-12 col-md-9">
																	<i class="fa fa-building text-primary mr-5 home"></i><strong class="mr-10 home"><?php echo $row['issuer']; ?></strong>
																</div>
									...
									<a href="app/drop-attachment.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this attachment ?')" class="btn  btn-sm btn-inverse">Delete</a>
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#0cb189; color:white" '; } ?> href="attachments.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
