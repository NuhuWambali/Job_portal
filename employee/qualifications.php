...
<head>
	...
	<title>FastJobs - Professional Qualifications</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span class="home">Professional Qualifications</span></li>
					</ol>
					...
					<div class="GridLex-gap-15-wrappper">
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li  class="active">
											<a href="qualifications.php"  style="color:#0cb189"><i class="fa fa-trophy"></i> Professional Qualifications</a>
										</li>
										<li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a  target="_blank" href="view-certificate.php?id=<?php echo $row['id']; ?>" >
															...
															<h4 style="color:#0cb189"><?php echo $row['title']; ?></h4>
															
															<div class="row">
																<div class="col-sm-12 col-md-9">
																	<i class="fa fa-graduation-cap text-primary mr-5" ></i><strong class="mr-10" style="color:#0cb189"><?php echo $row['institution']; ?></strong> <i class="fa fa-map-marker text-primary mr-5"></i><span style="color:#0cb189"> <?php echo $row['country']; ?></span>.
																</div>
																<div class="col-sm-12 col-md-3 mt-10-sm">
																	<i class="fa fa-calendar  text-primary mr-5"></i> <span style="color:#0cb189"><?php echo $row['timeframe']; ?></span>
																</div>
															</div>
												...
												<div class="col-sm-12 col-md-2">
													...
													<div class="resume-list-btn">
														...
														<a data-toggle="modal" href="#edit<?php echo $row['id']; ?>" class="btn  btn-sm mb-5 mb-0-sm">Edit</a>
									<a href="app/drop-qualification.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this qualification ?')" class="btn  btn-sm btn-inverse">Delete</a>
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#0cb189; color:white" '; } ?> href="qualifications.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
								...
								?>
									...
									<div class="mt-30">
										...
										<a data-toggle="modal" href="#QualifModal" class="btn  btn-lg">Add new</a>
