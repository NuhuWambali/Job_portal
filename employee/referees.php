...
<head>
	...
	<title>FastJob - Referees</title>
	<meta name="description" content="Online Job Management / Job Portal" />
	<meta name="keywords" content="job, work, resume, applicants, application, employee, employer, hire, hiring, human resource management, hr, online job management, company, worker, career, recruiting, recruitment" />
	<meta name="author" content="fastJob">
    ...
    <meta property="og:image:alt" content="fastJob" />
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span class="home">Referees</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li class="active">
											<a href="referees.php" class="color:#0cb189"><i class="fa fa-users"></i> Referees</a>
										</li>
										<li >
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a>
															...
															<h4 class="home"><?php echo "$refname"; ?></h4>
															
															<div class="row">
																<div class="col-sm-12 col-md-9">
																	<i class="fa fa-building text-primary mr-5 home"></i><strong class="mr-10 home"><?php echo $row['institution']; ?></strong> <i class="fa fa-user text-primary mr-5"></i> <span class="home"><?php echo "$reftitle"; ?></span>.
																</div>
									...
									<a href="app/drop-ref.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this referee ?')" class="btn  btn-sm btn-inverse">Delete</a>
