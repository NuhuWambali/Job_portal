...
<head>
	...
	<title>FastJobs - Applied Jobs</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span class="home">Applied Jobs</span></li>
					</ol>
					...
					<div class="GridLex-gap-15-wrappper">
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
                                  ...
                                  foreach($result as $row)
                                  {
	                                ...
	                                $sta = '<div class="job-label label " style="color:#fff; background-color:#000">
											Freelance
											</div>';
											  
	                                }
	                                if ($jobtype == "Part-time") {
	                                 $sta = '<div class="job-label label " style="color:#fff; background-color:#1134d1">
											Part-time
											</div>';
											  
	                                }
	                                if ($jobtype == "Full-time") {
	                                $sta = '<div class="job-label label " style="color:#fff; background-color:green">
											Full-time
											</div>';
								...
								<div class="GridLex-grid-middle">
									<div class="GridLex-col-6_xs-12">
										<div class="job-position">
											...
											<div class="content">
												<h4 class="home"><?php echo "$job_title"; ?></h4>
                                    ...
                                    <span class="home"> <?php echo "$sta"; ?></span>
										<span class="font12 block spacing1 font400 text-center "><span class="home"><?php echo "$post_month"; ?> <?php echo "$post_date"; ?>, <?php echo "$post_year"; ?></span></span>
									</div>
								</div>
							</a>
							...
							<?php
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#0cb189; color:white" '; } ?> href="applied-jobs.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
