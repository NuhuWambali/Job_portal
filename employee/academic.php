...
<head>
	...
	<title>FastJobs - Academic Qualifications</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a class="home" href="../">fastJobs</a></li>
						<li><span class="home">Academic Qualifications</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a  href="view-certificate-c.php?id=<?php echo $row['id']; ?>" >
															...
															<h4 class="home"><?php echo $row['course']; ?></h4>
															
															<div class="row">
																<div class="col-sm-12 col-md-9">
																	<i class="fa fa-graduation-cap text-primary mr-5 home"></i><strong class="mr-10 home"><?php echo $row['institution']; ?></strong> <i class="fa fa-map-marker text-primary mr-5 home"></i> <span class="home"> <?php echo $row['country']; ?></span>.
																</div>
																<div class="col-sm-12 col-md-3 mt-10-sm">
																	<i class="fa fa-calendar  text-primary mr-5 home"></i><span class="home"> <?php echo $row['timeframe']; ?></span>
																</div>
															</div>
									...
									<a href="app/drop-academic.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this qualification ?')" class="btn  btn-sm btn-inverse">Delete</a>
                                    ...
                                    {
										?>
										<option value="<?php echo $rowb['country_name']; ?>"><?php echo $rowb['country_name']; ?></option>
										<?php
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#0cb189; color:white" '; } ?> href="academic.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
