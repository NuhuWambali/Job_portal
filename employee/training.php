			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="../" style="color:#0cb189">fastJobs</a></li>
						<li><span class="home">Training</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li class="active">
											<a href="training.php" style="color:#0cb189"><i class="fa fa-gears"></i> Training & Workshop</a>
										</li>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a  <?php if ($certificate == "") { }else{ ?>  href="view-certificate-b.php?id=<?php echo $row['id']; ?> <?php } ?>" >
															...
															<h4 class="home"><?php echo $row['training']; ?></h4>
															
															<div class="row">
																<div class="col-sm-12 col-md-9">
																	<i class="fa fa-building text-primary mr-5"></i><strong class="mr-10 home"><?php echo $row['institution']; ?></strong>
																</div>
																<div class="col-sm-12 col-md-3 mt-10-sm">
																	<i class="fa fa-calendar  text-primary mr-5"></i> <span class="home"><?php echo $row['timeframe']; ?></span>
																</div>
															</div>
									...
									<a href="app/drop-training.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this training ?')" class="btn btn-sm btn-inverse">Delete</a>
		                        ...
		                        ?><li  class="paging-nav" ><a <?php if ($b == $page) { print ' style="background-color:#0cb189; color:white" '; } ?>  href="training.php?page=<?php echo "$b"; ?>"><?php echo $b." "; ?></a></li><?php
                                 }	
