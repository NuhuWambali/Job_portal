...
<head>
	...
	<title>FastJobs - Language Proficiency</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li><span class="home">Language Proficiency</span></li>
					</ol>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										...
										<li class="active">
											<a href="language.php" style="color:#0cb189"><i class="fa fa-language"></i> Language Proficiency</a>
										</li>
										<li>
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a >
															...
															<h4 style="color:#0cb189"><?php echo $row['language']; ?></h4>
															
															<div class="row">
																<div class="col-sm-12 col-md-12">
																	<i class="fa fa-user mr-5 home"></i><span class="home"> Speak - </span><strong class="mr-10" style="color:#0cb189"><?php echo $row['speak']; ?></strong> <i class="fa fa-book mr-5 home"></i><span class="home"> Read - </span><strong class="mr-10" style="color:#0cb189"><?php echo $row['reading']; ?></strong> <i class="fa fa-pencil mr-5 home"></i> <span class="home">Write - </span><strong class="mr-10" style="color:#0cb189"><?php echo $row['writing']; ?></strong>
																</div>
												...
												<div class="col-sm-12 col-md-2">
													...
													<div class="resume-list-btn">
														...
														<a href="app/drop-language.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this language ?')" class="btn  btn-sm btn-inverse">Delete</a>
