...
try {
	...
	$sta = '<span class="label label-success" style="color:#fff; background-color:#000">Freelance</span>';
											  
	}
	if ($jobtype == "Part-time") {
	$sta = '<span class="label label-danger" style="color:#fff; background-color:#1134d1">Part-time</span>';
											  
	}
	if ($jobtype == "Full-time") {
	$sta = '<span class="label label-warning" style="color:#fff; background-color:green">Full-time</span>';
...
<meta charset="utf-8">
	...
	<title>FastJobs - <?php echo "$jobtitle"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li ><a class="home" href="job-list.php">All jobs</a></li>
						<li ><a  class="home"  href="company.php?ref=<?php echo "$compid"; ?>"><?php echo "$compname"; ?></a></li>
						<li  class="home"><span><?php echo "$jobtitle"; ?></span></li>
					</ol>
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-header text-center">
									...
									<div class="meta-div clearfix mb-25">
										<span style="color:#0cb189">at <a style="color:#0cb189" href="company.php?ref=<?php echo "$compid"; ?>"><?php echo "$compname"; ?></a> as </span>
										<?php echo "$sta"; ?>
									</div>
									...
									<ul class="meta-list clearfix">
										...
										<span style="color:#0cb189"><?php echo "$jobcity"; ?> , <?php echo "$jobcountry"; ?></span>
										</li>
										<li>
											<h4 class="heading">Deadline:</h4>
											<span style="color:#0cb189"><?php echo "$post_month"; ?> <?php echo "$post_date"; ?>, <?php echo "$post_year"; ?></span>
										</li>
										<li>
											<h4 class="heading">Experience</h4>
											<span style="color:#0cb189"><?php echo "$experience"; ?> </span>
										</li>
										<li>
											<h4 class="heading">Posted: </h4>
											<span style="color:#0cb189"><?php echo "$opendate"; ?> </span>
										</li>
									</ul>
						        ...
						        if ($user_online == true) {
								if ($jobexpired == true) {
								print '<button class="btn  disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-calendar"></i> This job is expired</button>';
								}else{
								if ($myrole == "employee") {
                                print '<button';?> onclick="update(this.value)" <?php print ' value="'.$jobid.'" class="btn  btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-pencil"></i> Apply this job</button>';
								}else{
								print '<button class="btn  disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Login as employee to apply</button>';
								}	
								}
								...
								print '<button class="btn  disabled btn-hidden btn-lg collapsed"><i class="flaticon-line-icon-set-padlock"></i> Login to apply this job</button>';	
								}
								...
								<div class="tab-style-01">
									...
									<ul class="nav" role="tablist">
										<li role="presentation" class="active"><h4 ><a style="color:#0cb189" href="#relatedJob1" role="tab" data-toggle="tab">More jobs from <?php echo "$compname"; ?></a></h4></li>
									</ul>
