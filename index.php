		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/01.jpg');">
				<div class="container">
					...
					<h1>your bright <span  <span id="animationHead">future </span> starts here now</h1>
					<p >Find your next job or Task on Fast Jobs</p>
					...
					<div class="main-search-form-wrapper">
						...
						<form action="job-list.php" method="GET" autocomplete="off">
							...
							<div class="form-holder">
								<div class="row gap-0">
									...
									<div class="col-xss-6 col-xs-6 col-sm-6" >
										...
										<option style="color:#0cb198" value="<?php echo $row['category']; ?>"><?php echo $row['category']; ?></option>
										<?php
	                                     }
                                         $stmt->execute();
									...
									<div class="col-xss-6 col-xs-6 col-sm-6">
										...
										<option style="color:#0cb189" value="<?php echo $row['country_name']; ?>"><?php echo $row['country_name']; ?></option>
										<?php
	                                     }
                                         $stmt->execute();
							...
							<div class="btn-holder">
								<button name="search" value="✓" type="submit" class="btn" style="border:none"><i class="ion-android-search"></i></button>
							</div>
			...
			<div class="pt-0 pb-50">
				...
				<div class="container">
					...
					<h6 style="color:#0cb189"><?php echo $row['first_name'];?></h6>
					<a href="company.php?ref=<?php echo $row['member_no']; ?>">View Company</a>
					</div>
				...
				<div class="container">
					...
					<div class="row">
						...
						<div class="col-md-12">
							...
							if ($type == "Freelance") {
							$sta = '<div class="job-label label label-success" style="color:#fff; background-color:#000">
									Freelance
									</div>';
											  
							}
							if ($type == "Part-time") {
							$sta = '<div class="job-label label label-danger" style="color:#fff; background-color:#1134d1">
									Part-time
									</div>';
											  
							}
							if ($type == "Full-time") {
							$sta = '<div class="job-label label label-warning" style="color:#fff; background-color:green">
									Full-time
									</div>';
							...
							<div class="content">
							<h4 style="color:#0cb189"><?php echo "$title"; ?></h4>
							...
							<?php echo "$sta"; ?>
							<span class="font12 block spacing1 font400 text-center1">Apply before - <?php echo "$post_month"; ?> <?php echo "$post_date"; ?>, <?php echo "$post_year"; ?></span>
							</div>
							</div>
							</a>
